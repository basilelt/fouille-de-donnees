...
import content_bayes
import content_clustering
import content_decision_tree
import content_introduction
import content_kmeans
import content_knn
import content_neural_network
import content_time_series
import content_wooclap

# Topic modules registry
TOPIC_MODULES = {
    "bayes": content_bayes,
    "clustering": content_clustering,
    "decision-tree": content_decision_tree,
    "introduction": content_introduction,
    "kmeans": content_kmeans,
    "knn": content_knn,
    "neural-network": content_neural_network,
    "time-series": content_time_series,
    "wooclap": content_wooclap,
}
